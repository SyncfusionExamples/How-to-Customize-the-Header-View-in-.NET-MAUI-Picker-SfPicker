# How to Customize the Header View in the .NET MAUI Picker (SfPicker)

This repository contains the sample code to customize the header view in the [SfPicker](https://help.syncfusion.com/maui/picker/getting-started) control.
